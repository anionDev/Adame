...
# Internal rules:
alert tcp any any -> {local_ip_address} any (sid: {self._private_testrule_sid}; content: "{self.get_entire_testrule_trigger_content()}"; msg: "{self.get_entire_testrule_trigger_answer()}"; react: msg;) # Test-rule for functionality test
