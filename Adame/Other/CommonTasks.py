...
def common_tasks():
    ...
    sc.replace_version_in_ini_file(GeneralUtilities.resolve_relative_path("../pyproject.toml", folder_of_current_file), version)
    ...
    tfcps.standardized_tasks_do_common_tasks(file, version, 1, "QualityCheck", True, None, sys.argv)
